...
const translations: Record<Language, TranslationStrings> = {
  ...
  en: {
    ...
    channels: {
      ...
      byopDesc: 'Connect your existing SMS, email or RCS provider directly to our platform.',
      managed: 'Managed by messaging.dk',
